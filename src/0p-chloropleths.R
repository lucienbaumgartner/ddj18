### Q: Which districts has the most children?
## NEED:
##- shapefile
##- data aggregated per district for last five years; -> median over 5 years!

library(dpylr) # data crunching
...
table(unique(shp$QNAME)%in%unique(kids$quarlang))
